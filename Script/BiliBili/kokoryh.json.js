// 2024.11.12 23:16
// https://github.com/kokoryh/Script/blob/master/js/bilibili.json.js
...
try {
    ...
    const t = {
        ...
        "v2/splash/": function(i) { ["show", "event_list"].forEach((e = >{
                i.data[e] && (i.data[e] = [])
            })),
            $done({
                body: JSON.stringify(i)
        ...
        "feed/index/story?": function(i) {
            Array.isArray(i.data.items) && (i.data.items = i.data.items.filter((i = >!i.ad_info && !i.card_goto ? .startsWith("ad"))));
            $done({
                body: JSON.stringify(i)
            })
        },
        "account/mine": function(i) {
            ...
            i.data.vip && !i.data.vip.status && (i.data.vip_type = 2, Object.assign(i.data.vip, {
                status: 1,
                type: 2,
                vip_pay_type: 1,
    ...
    for (const a in t) if (i.includes(a)) {
        t[a](e);
        break
    }
} catch(i) {
